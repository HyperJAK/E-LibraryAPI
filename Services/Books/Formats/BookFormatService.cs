...
using ELib_IDSFintech_Internship.Repositories.Books.Formats;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Caching.Memory;

namespace ELib_IDSFintech_Internship.Services.Books.Formats
{
    public class BookFormatService : IBookFormatRepository
    {
        ...
        public async Task<BookFormat?> Create(BookFormat newObject)
        {
            ...
            try
            {
                ...
                var getUpdated = await _context.BookFormats.Where(x => x.Id == newObject.Id).FirstOrDefaultAsync();
