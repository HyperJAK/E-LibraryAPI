...
namespace ELib_IDSFintech_Internship.Controllers.Books.Locations
{
    [ApiController]
    [Route("[controller]")]
    public class BookLocationController : ControllerBase
    {
        ...
        private readonly BookLocationService _service;
        private readonly ILogger<BookLocationController> _logger;
        ...
        public BookLocationController(ILogger<BookLocationController> logger, BookLocationService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("api/create")]
        public async Task<IActionResult> Create(BookLocation newObject)
        {
        ...
        [HttpPut("api/update")]
        public async Task<IActionResult> Update(BookLocation modifiedObject)
        {
