...
namespace ELib_IDSFintech_Internship.Controllers.Books.Tags
{
    [ApiController]
    [Route("[controller]")]
    public class BookTagController : ControllerBase
    {
        ...
        private readonly BookTagService _service;
        private readonly ILogger<BookTagController> _logger;
        ...
        public BookTagController(ILogger<BookTagController> logger, BookTagService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("api/create")]
        public async Task<IActionResult> Create(BookTag newObject)
        {
        ...
        [HttpPut("api/update")]
        public async Task<IActionResult> Update(BookTag modifiedObject)
        {
