...
namespace ELib_IDSFintech_Internship.Controllers.Books.Genres
{
    [ApiController]
    [Route("[controller]")]
    public class BookGenreController : ControllerBase
    {
        private readonly BookGenreService _service;
        ...
        public BookGenreController(ILogger<BookGenreController> logger, BookGenreService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("api/create")]
        public async Task<IActionResult> Create(BookGenre newObject)
        {
        ...
        [HttpPut("api/update")]
        public async Task<IActionResult> Update(BookGenre modifiedObject)
        {
