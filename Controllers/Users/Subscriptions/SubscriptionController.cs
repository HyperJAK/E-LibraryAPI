...
namespace ELib_IDSFintech_Internship.Controllers.Users.Subscriptions
{
    [ApiController]
    [Route("[controller]")]
    public class SubscriptionController : ControllerBase
    {
        ...
        public SubscriptionController(ILogger<SubscriptionController> logger, SubscriptionService service)
        {
            _logger = logger;
            _service = service;
        }
        ...
        [HttpPost("api/create")]
        public async Task<IActionResult> Create(Subscription newObject)
        {
        ...
        [HttpPut("api/update")]
        public async Task<IActionResult> Update(Subscription modifiedObject)
        {
