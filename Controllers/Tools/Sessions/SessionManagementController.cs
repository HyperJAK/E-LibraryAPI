...
namespace ELib_IDSFintech_Internship.Controllers.Tools.Sessions
{
    [ApiController]
    [Route("[controller]")]
    public class SessionManagementController : ControllerBase
    {
        ...
        public SessionManagementController(ILogger<SessionManagementController> logger, SessionManagementService service)
        {
            _logger = logger;
            _service = service;
        }
