...
using ELib_IDSFintech_Internship.Repositories.Sessions;
...
namespace ELib_IDSFintech_Internship.Services.Sessions
{
    public class SessionManagementRepository : ISessionManagementRepository
    {
        ...
        public SessionManagementRepository(Data.ELibContext context, ILogger<SessionManagementRepository> logger, IMemoryCache memoryCache, AES256Encryption securityAES)
        {
            _context = context;
            _logger = logger;
